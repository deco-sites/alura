                            ...
                            <div class="flex flex-col items-center gap-12 mt-[15px] md:gap-0 md:mt-28 md:flex-row lg:justify-center">
                                {cards.listCard.map((card, index) => (
                                    <div
                                        ...
                                        class={`w-full max-w-[380px] relative mx-auto lg:mx-[initial] ${index === 1 ? "md:ml-[-1rem]" : ''} ${card.highlight
                                                ...
                                                <ul class="px-8">
                                                    {card.contentList.map((list) => (
                                                        <li
                                                            ...
                                                            class={`flex items-center mb-4 text-[14px] text-[#D7F9FF] flex-wrap gap-2 pl-8 ${list.highlight ? `listHighlight border-solid border-[1px] border-[#0E4953] bg-[#142342] p-[.6rem] relative` : ''}`}
                                                        >
                                                            <div class="max-w-[85%]">
                                                                {list.listText && <span dangerouslySetInnerHTML={{ __html: list.listText }}></span>}
                                                                <div
